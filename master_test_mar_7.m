...
for i = 1:size(T,3)
    ...
    first_converted_theta_list = mod((Rad2BitM(new_thetalist(1)) + 1024),4095);
    second_converted_theta_list = mod((Rad2BitM(new_thetalist(2)) + 2048), 4095);
    final_converted_theta_list = mod((Rad2BitA(new_thetalist(3:5)) + 512), 1023);
